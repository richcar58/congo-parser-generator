//! Visitor for depth-first AST traversal.
...
impl Arena {
        ...
        F: FnMut(NodeId, &AstNode, &Arena, usize, Option<&dyn Any>) -> VisitControl,
    {
        ...
        let children: Vec<NodeId> = match node {
            AstNode::SqlExpression(n) => n.children.clone(),
            AstNode::OrExpression(n) => n.children.clone(),
            AstNode::AndExpression(n) => n.children.clone(),
            AstNode::NotExpression(n) => n.children.clone(),
            AstNode::ComparisonExpression(n) => n.children.clone(),
            AstNode::ValueList(n) => n.children.clone(),
            AstNode::AdditiveExpression(n) => n.children.clone(),
            AstNode::MultiplicativeExpression(n) => n.children.clone(),
            AstNode::UnaryExpression(n) => n.children.clone(),
            AstNode::PrimaryExpression(n) => n.children.clone(),
        };
